...
- Update to work with ponyc 0.70.0 ([PR #479](https://github.com/ponylang/ponyup/pull/479))
...
- Add Alpine 3.24 as a supported platform ([PR #446](https://github.com/ponylang/ponyup/pull/446))

### Changed

- Require ponyc 0.64.0 or later ([PR #429](https://github.com/ponylang/ponyup/pull/429))
...
- Add request timeouts ([PR #380](https://github.com/ponylang/ponyup/pull/380))
...
- Remove stable from supported applications ([PR #364](https://github.com/ponylang/ponyup/pull/364))
...
- Add support for pony-lint ([PR #347](https://github.com/ponylang/ponyup/pull/347))
