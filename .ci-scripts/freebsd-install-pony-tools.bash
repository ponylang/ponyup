...
cd /tmp
mkdir corral
curl -O 'https://dl.cloudsmith.io/public/ponylang/releases/raw/versions/latest/corral-x86-64-unknown-freebsd12.1.tar.gz'
tar -xvf corral-x86-64-unknown-freebsd12.1.tar.gz -C corral --strip-components=1
